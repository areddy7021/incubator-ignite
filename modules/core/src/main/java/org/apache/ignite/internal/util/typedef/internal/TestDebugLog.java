...
public class TestDebugLog {
    ...
    static class EntryMessage extends Message {
        ...
        public String toString() {
            return "EntryMsg [key=" + key + ", val=" + val + ", msg=" + msg + ", thread" + thread + ']';
        }
    }
    ...
    public static void printMessages(@Nullable String fileName) {
        List<Object> msgs0;
    ...
    public static void printKeyMessages(@Nullable String fileName, Object key) {
        List<Object> msgs0;
